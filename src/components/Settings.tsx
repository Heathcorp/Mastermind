        ...
        >
          <div class="settings-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div class="settings-container" style={{ "min-width": "300px" }}>
              ...
              >
                <For
                  each={Object.entries(app.config()).filter(([key]) =>
                    tickboxKeys.includes(key as keyof OptimisationSettings)
                  )}
                >
...
const optimisationLabels: Record<keyof OptimisationSettings, string> = {
  ...
  optimise_generated_all_permutations: "generated code permutations",
